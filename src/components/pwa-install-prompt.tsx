  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-80 z-50 glass-gold rounded-xl p-4 gold-glow border border-gold/30 flex items-center gap-3">
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs text-muted-foreground mt-0.5">Add to your home screen for instant access.</div>
      </div>
      ...
      <button onClick={() => setDismissed(true)} className="shrink-0 text-muted-foreground hover:text-foreground" aria-label="Dismiss">
        <X className="w-4 h-4" />
      </button>
    </div>
  );
